<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewanswers.aspx.cs" Inherits="viewanswers" StylesheetTheme="them1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Online Examination System - View Answers</title>
</head>
	...
	<table border="0" width="1262" cellspacing="0" id="table1">
		...
		<tr>
			...
			&nbsp;<asp:Button ID="BtnBack" runat="server" Text="< Back" Width="57px" OnClick="BtnBack_Click" />&nbsp;
                ...
                &nbsp; &nbsp; &nbsp;&nbsp;
                <asp:Button ID="BtnEnd" runat="server" Text="Back to Result" Width="117px" OnClick="BtnEnd_Click" />
                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
            </td>
		</tr>
	</table>
