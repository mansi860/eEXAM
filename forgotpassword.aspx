...
<head id="Head1" runat="server">
    <title>Online Examination System - Forgot Password</title>
</head>
				...
				<tr>
					...
					<table border="0" width="98%" id="table4" cellspacing="0">
						...
						<tr>
							...
							</b><strong>Existing user you can get back your exitsing password.</strong><br>
							<br>
							    .<br>
...
<td width="308" align="left" valign="top"><font face="Arial">
    <asp:TextBox ID="TxtEmailID" runat="server" BackColor="White" Width="227px"></asp:TextBox></font></td>
</tr>
<tr>
