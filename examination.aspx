<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examination.aspx.cs" Inherits="examination" StylesheetTheme="them1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Online Examination System - Start Examination</title>
</head>
					...
					<table border="0" width="98%" id="table4" cellspacing="0">
						...
						<tr>
							...
							<font face="Arial" size="2"><b><br>
                                Start a new examination</b>&nbsp;</font><table width="661" border="0" cellpadding="3" id="table5">
<tr>
...
<td width="495" align="left" valign="top"><font face="Arial"><span id="sp_name" runat="server" >
    <asp:DropDownList ID="DdlExamination" runat="server" Width="255px" OnSelectedIndexChanged="DdlExamination_SelectedIndexChanged" AutoPostBack="True">
    </asp:DropDownList></span></font></td>
</tr>
<tr>
...
<tr>
<td align="right" valign="top" width="148"><b><font face="Arial" size="2">No of Qusetion :</font></b></td>
<td width="495" align="left" valign="top"><font face="Arial"><span id="sp_no_qusetion" runat="server" ></span>
    </font></td>
</tr>
<tr>
<td align="right" valign="top" width="148"><b><font face="Arial" size="2">Total Time :</font></b></td>
<td width="495" align="left" valign="top"><font face="Arial"><span id="sp_total_time" runat="server" ></span>
    </font></td>
</tr>
<tr>
<td align="right" valign="top" width="148">
    <strong><span style="font-size: 10pt; font-family: Arial">Total Marks :</span></strong></td>
<td width="495" align="left" valign="top"><font face="Arial"><span id="sp_total_marks" runat="server" ></span>
    </font></td>
</tr>
<tr>
  <td align="right" valign="top" width="148">
      <strong><span style="font-size: 10pt; font-family: Arial">Passing Marks :</span></strong></td>
  <td align="left" valign="top" width="495"><font face="Arial"><span id="sp_passing_marks" runat="server" ></span>
    </font></td>
</tr>
                                    <tr>
                                        <td align="right" valign="top" width="148">
                      ...
                      <tr>
                          ...
                          <td align="left" valign="top" width="495">
                              <asp:Button ID="BtnStart" runat="server" Text="Start Exmination" Width="128px" OnClick="BtnStart_Click" />&nbsp;
                              <asp:Button ID="BtnBack" runat="server" OnClick="BtnBack_Click" Text="Back" Width="55px" /></td>
                      </tr>
<tr>
<td align="left" valign="top" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom-style: solid; border-bottom-width: 1px" colspan="2">
</td>
